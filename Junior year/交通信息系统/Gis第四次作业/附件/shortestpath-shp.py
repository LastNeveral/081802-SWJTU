...
# 创建结果的shp文件
##################################
def writeShp(splink, spnode, o, d):
    # 补充完整代码
    o = str(o)
    d = str(d)
    ...
    addr = sys.path[0]
    writer = QgsVectorFileWriter('C://Users//Mr.Liu//Desktop//shortestpath'+o+'_'+d+'.shp','UTF-8',layerFields,\
...
#设置文件名称
##################################
Link_layer = "C://Users//Mr.Liu//Desktop//交通信息系统//Gis第四次作业//附件//ChicagoSketch-ex1_lnk_s.shp"
Node_layer = "C://Users//Mr.Liu//Desktop//交通信息系统//Gis第四次作业//附件//ChicagoSketch-ex1_nod_s.shp"
...
random.seed(4)
for i in range(0,5):
    o = random.randint(0,933)
    d = random.randint(0,933)
